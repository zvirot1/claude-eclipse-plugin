...
1. Browse the **[releases folder on Azure DevOps](https://vstsleumi.visualstudio.com/AI-helper-extensions/_git/claude-eclipse-plugin?path=/releases&version=GBeclipse-4.38-main)**
2. Download the latest ZIP for **Eclipse 4.38** (`claude-eclipse-plugin-update-site-4.38-*.zip`)
