...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
        ...
        // Tab-title strategy — self_generated by default (LLM-written 3-5 word topic).
        store.setDefault(PreferenceConstants.TAB_TITLE_STRATEGY, "self_generated");

        // Per-bubble timestamps — ON by default. The format is HH:MM:SS for
