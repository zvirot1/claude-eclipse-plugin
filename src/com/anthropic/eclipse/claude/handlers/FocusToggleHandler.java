 ...
 *
 * - If Claude panel already has focus → return focus to the active editor.
...
public class FocusToggleHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        IViewPart claudeView = page.findView(ClaudeConversationView.ID);

        // If the Claude view already has focus, move back to the active editor
